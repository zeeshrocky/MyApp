    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r = new Runnable() {
            ...
            public void run() {
                ...
                Intent timer = new Intent(req3.this,Main2Activity.class);
                webview.destroy();
        ...
        startWebView("http://ee.co.uk/help/add-ons-benefits-and-plans/calling-texting-and-data-add-ons");


        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent backInt = new Intent(req3.this,MainActivity.class);
                webview.destroy();
                webview.clearHistory();
                webview.clearFormData();
                webview.clearCache(true);
