...
public class req1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r = new Runnable() {
            ...
            public void run() {
                ...
                Intent timer = new Intent(req1.this,Main2Activity.class);
                webview.destroy();
       ...
       // startHandler();
        ...
        startWebView("http://ee.co.uk/help/download-the-my-ee-app");


        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent backInt = new Intent(req1.this,MainActivity.class);
                webview.destroy();
                webview.clearHistory();
                webview.clearFormData();
                webview.clearCache(true);
                ...
                webview.setWebViewClient(new WebViewClient() {
                    ...
                    public void onLoadResource (WebView view, String url) {
                        if (progressDialog == null) {
                            ...
                            progressDialog = new ProgressDialog(req1.this);
