...
public class req2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_req2);
        ...
        r = new Runnable() {
            ...
            public void run() {
                ...
                Intent timer = new Intent(req2.this,Main2Activity.class);
                webview.destroy();
        ...
        startWebView("http://ee.co.uk/why-ee/apple-music");


        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent backInt = new Intent(req2.this,MainActivity.class);
                webview.destroy();
                webview.clearHistory();
                webview.clearFormData();
                webview.clearCache(true);
                ...
                webview.setWebViewClient(new WebViewClient() {
                    ...
                    public void onLoadResource (WebView view, String url) {
                        if (progressDialog == null) {
                            ...
                            progressDialog = new ProgressDialog(req2.this);
